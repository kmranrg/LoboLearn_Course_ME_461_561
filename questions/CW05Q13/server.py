...
def generate(data):
    X = np.array([[random.randint(50, 55)],
                  [random.randint(-5, 5)],
                  [1]])
    Wb = np.array([[random.randint(-5, -1), random.randint(-5, 5), random.randint(-5, 5)],
                   [random.randint(-5, 5), random.randint(-5, 5), random.randint(-5, 5)],
                   [random.randint(1, 5), random.randint(-5, 5), random.randint(-5, 5)]])
    H = np.dot(Wb, X)
    ...
    #data["correct_answers"]["activation"] = answer